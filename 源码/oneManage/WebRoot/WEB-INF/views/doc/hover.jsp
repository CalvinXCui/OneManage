...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path }/system/images/hover/demopage.css" media="all">
    <link rel="stylesheet" type="text/css" href="${path }/common/css/hover.css" media="all">
</head>
</head>
<body>
...
<script type="text/javascript" src="${path }/system/subgroup/js/hover.js"></script>
